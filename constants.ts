...
export const SKILLS: Skill[] = [
  ...
  { name: "Azure DevOps", icon: GitBranch, category: "devops" },
  { name: "GitHub Actions", icon: GitBranch, category: "devops" },
  { name: "Linux", icon: Terminal, category: "devops" },
  { name: "Python", icon: Code, category: "scripting" },
  { name: "Bash", icon: Terminal, category: "scripting" },
  { name: "CloudFormation", icon: Cloud, category: "devops" },
  { name: "AWS CDK", icon: Layers, category: "devops" },
  { name: "Git", icon: GitBranch, category: "devops" },
  { name: "Datadog", icon: ChartNetwork, category: "monitoring" },
  { name: "CloudWatch", icon: ChartNetwork, category: "monitoring" },
  { name: "Redis", icon: Database, category: "devops" },
];
